        ...
        <div className="mb-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="px-4 py-2 bg-[#FCD535] text-black/80 rounded hover:bg-[#FCD535]/80 transition-colors"
            >
            ...
            <div className="space-y-6">
              <div className="bg-gray-800 rounded-lg border border-gray-700 h-full">
                <div className="flex flex-col h-full justify-between">
                  <div className="p-4 flex w-full justify-between border-b border-gray-700">
                    ...
                    <div className="flex w-fit  gap-4  border-gray-700">
                      ...
                      <button
                        type="submit"
                        className="px-6 py-3 bg-[#FCD535] text-black/80 rounded hover:bg-[#FCD535]/80 transition-colors disabled:opacity-50"
                        disabled={isLoading}
                      >
